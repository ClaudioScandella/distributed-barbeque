 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status Discover(::grpc::ClientContext* context, const ::bbque::GenericRequest& request, ::bbque::GenericReply* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::bbque::GenericReply>> AsyncDiscover(::grpc::ClientContext* context, const ::bbque::GenericRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::bbque::GenericReply>>(AsyncDiscoverRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::bbque::GenericReply>> PrepareAsyncDiscover(::grpc::ClientContext* context, const ::bbque::GenericRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::bbque::GenericReply>>(PrepareAsyncDiscoverRaw(context, request, cq));
    }
    ...
    class experimental_async_interface {
     public:
      ...
      virtual void Discover(::grpc::ClientContext* context, const ::bbque::GenericRequest* request, ::bbque::GenericReply* response, std::function<void(::grpc::Status)>) = 0;
  ...
  private:
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::bbque::GenericReply>* AsyncDiscoverRaw(::grpc::ClientContext* context, const ::bbque::GenericRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::bbque::GenericReply>* PrepareAsyncDiscoverRaw(::grpc::ClientContext* context, const ::bbque::GenericRequest& request, ::grpc::CompletionQueue* cq) = 0;
  ...
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status Discover(::grpc::ClientContext* context, const ::bbque::GenericRequest& request, ::bbque::GenericReply* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::bbque::GenericReply>> AsyncDiscover(::grpc::ClientContext* context, const ::bbque::GenericRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::bbque::GenericReply>>(AsyncDiscoverRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::bbque::GenericReply>> PrepareAsyncDiscover(::grpc::ClientContext* context, const ::bbque::GenericRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::bbque::GenericReply>>(PrepareAsyncDiscoverRaw(context, request, cq));
    }
    ...
    class experimental_async final :
     ...
     public:
      void Discover(::grpc::ClientContext* context, const ::bbque::GenericRequest* request, ::bbque::GenericReply* response, std::function<void(::grpc::Status)>) override;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::bbque::GenericReply>* AsyncDiscoverRaw(::grpc::ClientContext* context, const ::bbque::GenericRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::bbque::GenericReply>* PrepareAsyncDiscoverRaw(::grpc::ClientContext* context, const ::bbque::GenericRequest& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    Service();
    virtual ~Service();
    virtual ::grpc::Status Discover(::grpc::ServerContext* context, const ::bbque::GenericRequest* request, ::bbque::GenericReply* response);
  ...
  class WithAsyncMethod_Discover : public BaseClass {
   ...
   public:
    ...
    ::grpc::Status Discover(::grpc::ServerContext* context, const ::bbque::GenericRequest* request, ::bbque::GenericReply* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestDiscover(::grpc::ServerContext* context, ::bbque::GenericRequest* request, ::grpc::ServerAsyncResponseWriter< ::bbque::GenericReply>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  class ExperimentalWithCallbackMethod_Discover : public BaseClass {
   ...
   public:
    ...
    virtual void Discover(::grpc::ServerContext* context, const ::bbque::GenericRequest* request, ::bbque::GenericReply* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
   ...
   public:
    WithStreamedUnaryMethod_Discover() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler< ::bbque::GenericRequest, ::bbque::GenericReply>(std::bind(&WithStreamedUnaryMethod_Discover<BaseClass>::StreamedDiscover, this, std::placeholders::_1, std::placeholders::_2)));
    }
    ...
    virtual ::grpc::Status StreamedDiscover(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::bbque::GenericRequest,::bbque::GenericReply>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
