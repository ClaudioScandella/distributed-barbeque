...
extern DiscoverReplyDefaultTypeInternal _DiscoverReply_default_instance_;
...
template<> ::bbque::DiscoverReply* Arena::CreateMaybeMessage<::bbque::DiscoverReply>(Arena*);
template<> ::bbque::DiscoverRequest* Arena::CreateMaybeMessage<::bbque::DiscoverRequest>(Arena*);
...
enum DiscoverRequest_IAm {
  DiscoverRequest_IAm_INSTANCE = 0,
  DiscoverRequest_IAm_NEW = 1,
  DiscoverRequest_IAm_MASTER = 2,
  DiscoverRequest_IAm_DiscoverRequest_IAm_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  DiscoverRequest_IAm_DiscoverRequest_IAm_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool DiscoverRequest_IAm_IsValid(int value);
const DiscoverRequest_IAm DiscoverRequest_IAm_IAm_MIN = DiscoverRequest_IAm_INSTANCE;
const DiscoverRequest_IAm DiscoverRequest_IAm_IAm_MAX = DiscoverRequest_IAm_MASTER;
const int DiscoverRequest_IAm_IAm_ARRAYSIZE = DiscoverRequest_IAm_IAm_MAX + 1;

const ::google::protobuf::EnumDescriptor* DiscoverRequest_IAm_descriptor();
inline const ::std::string& DiscoverRequest_IAm_Name(DiscoverRequest_IAm value) {
  return ::google::protobuf::internal::NameOfEnum(
    DiscoverRequest_IAm_descriptor(), value);
}
inline bool DiscoverRequest_IAm_Parse(
    const ::std::string& name, DiscoverRequest_IAm* value) {
  return ::google::protobuf::internal::ParseNamedEnum<DiscoverRequest_IAm>(
    DiscoverRequest_IAm_descriptor(), name, value);
}
enum DiscoverReply_IAm {
  DiscoverReply_IAm_INSTANCE = 0,
  DiscoverReply_IAm_SLAVE = 1,
  DiscoverReply_IAm_MASTER = 2,
  DiscoverReply_IAm_DiscoverReply_IAm_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  DiscoverReply_IAm_DiscoverReply_IAm_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool DiscoverReply_IAm_IsValid(int value);
const DiscoverReply_IAm DiscoverReply_IAm_IAm_MIN = DiscoverReply_IAm_INSTANCE;
const DiscoverReply_IAm DiscoverReply_IAm_IAm_MAX = DiscoverReply_IAm_MASTER;
const int DiscoverReply_IAm_IAm_ARRAYSIZE = DiscoverReply_IAm_IAm_MAX + 1;

const ::google::protobuf::EnumDescriptor* DiscoverReply_IAm_descriptor();
inline const ::std::string& DiscoverReply_IAm_Name(DiscoverReply_IAm value) {
  return ::google::protobuf::internal::NameOfEnum(
    DiscoverReply_IAm_descriptor(), value);
}
inline bool DiscoverReply_IAm_Parse(
    const ::std::string& name, DiscoverReply_IAm* value) {
  return ::google::protobuf::internal::ParseNamedEnum<DiscoverReply_IAm>(
    DiscoverReply_IAm_descriptor(), name, value);
}
...
class DiscoverRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:bbque.DiscoverRequest) */ {
 public:
  DiscoverRequest();
  ...
  typedef DiscoverRequest_IAm IAm;
  static const IAm INSTANCE =
    DiscoverRequest_IAm_INSTANCE;
  static const IAm NEW =
    DiscoverRequest_IAm_NEW;
  static const IAm MASTER =
    DiscoverRequest_IAm_MASTER;
  static inline bool IAm_IsValid(int value) {
    return DiscoverRequest_IAm_IsValid(value);
  }
  static const IAm IAm_MIN =
    DiscoverRequest_IAm_IAm_MIN;
  static const IAm IAm_MAX =
    DiscoverRequest_IAm_IAm_MAX;
  static const int IAm_ARRAYSIZE =
    DiscoverRequest_IAm_IAm_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  IAm_descriptor() {
    return DiscoverRequest_IAm_descriptor();
  }
  static inline const ::std::string& IAm_Name(IAm value) {
    return DiscoverRequest_IAm_Name(value);
  }
  static inline bool IAm_Parse(const ::std::string& name,
      IAm* value) {
    return DiscoverRequest_IAm_Parse(name, value);
  }
  ...
  void clear_iam();
  static const int kIamFieldNumber = 1;
  ::bbque::DiscoverRequest_IAm iam() const;
  void set_iam(::bbque::DiscoverRequest_IAm value);

  // @@protoc_insertion_point(class_scope:bbque.DiscoverRequest)
 private:
...
class DiscoverReply : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:bbque.DiscoverReply) */ {
 public:
  DiscoverReply();
  virtual ~DiscoverReply();

  DiscoverReply(const DiscoverReply& from);

  inline DiscoverReply& operator=(const DiscoverReply& from) {
    CopyFrom(from);
    return *this;
  }
  #if LANG_CXX11
  DiscoverReply(DiscoverReply&& from) noexcept
    : DiscoverReply() {
    *this = ::std::move(from);
  }

  inline DiscoverReply& operator=(DiscoverReply&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  #endif
  static const ::google::protobuf::Descriptor* descriptor();
  static const DiscoverReply& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const DiscoverReply* internal_default_instance() {
    return reinterpret_cast<const DiscoverReply*>(
               &_DiscoverReply_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    3;

  void Swap(DiscoverReply* other);
  friend void swap(DiscoverReply& a, DiscoverReply& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline DiscoverReply* New() const final {
    return CreateMaybeMessage<DiscoverReply>(NULL);
  }

  DiscoverReply* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<DiscoverReply>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
  void CopyFrom(const DiscoverReply& from);
  void MergeFrom(const DiscoverReply& from);
  void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(DiscoverReply* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
  ...
  typedef DiscoverReply_IAm IAm;
  static const IAm INSTANCE =
    DiscoverReply_IAm_INSTANCE;
  static const IAm SLAVE =
    DiscoverReply_IAm_SLAVE;
  static const IAm MASTER =
    DiscoverReply_IAm_MASTER;
  static inline bool IAm_IsValid(int value) {
    return DiscoverReply_IAm_IsValid(value);
  }
  static const IAm IAm_MIN =
    DiscoverReply_IAm_IAm_MIN;
  static const IAm IAm_MAX =
    DiscoverReply_IAm_IAm_MAX;
  static const int IAm_ARRAYSIZE =
    DiscoverReply_IAm_IAm_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  IAm_descriptor() {
    return DiscoverReply_IAm_descriptor();
  }
  static inline const ::std::string& IAm_Name(IAm value) {
    return DiscoverReply_IAm_Name(value);
  }
  static inline bool IAm_Parse(const ::std::string& name,
      IAm* value) {
    return DiscoverReply_IAm_Parse(name, value);
  }
  ...
  void clear_iam();
  static const int kIamFieldNumber = 1;
  ::bbque::DiscoverReply_IAm iam() const;
  void set_iam(::bbque::DiscoverReply_IAm value);
  ...
  // @@protoc_insertion_point(class_scope:bbque.DiscoverReply)
 private:
...
// .bbque.DiscoverRequest.IAm iam = 1;
inline void DiscoverRequest::clear_iam() {
  iam_ = 0;
}
inline ::bbque::DiscoverRequest_IAm DiscoverRequest::iam() const {
  // @@protoc_insertion_point(field_get:bbque.DiscoverRequest.iam)
  return static_cast< ::bbque::DiscoverRequest_IAm >(iam_);
}
inline void DiscoverRequest::set_iam(::bbque::DiscoverRequest_IAm value) {
  
  iam_ = value;
  // @@protoc_insertion_point(field_set:bbque.DiscoverRequest.iam)
}
...
// .bbque.DiscoverReply.IAm iam = 1;
inline void DiscoverReply::clear_iam() {
  iam_ = 0;
}
inline ::bbque::DiscoverReply_IAm DiscoverReply::iam() const {
  // @@protoc_insertion_point(field_get:bbque.DiscoverReply.iam)
  return static_cast< ::bbque::DiscoverReply_IAm >(iam_);
}
inline void DiscoverReply::set_iam(::bbque::DiscoverReply_IAm value) {
  
  iam_ = value;
  // @@protoc_insertion_point(field_set:bbque.DiscoverReply.iam)
}

// uint32 id = 2;
inline void DiscoverReply::clear_id() {
  id_ = 0u;
}
inline ::google::protobuf::uint32 DiscoverReply::id() const {
  // @@protoc_insertion_point(field_get:bbque.DiscoverReply.id)
  return id_;
}
inline void DiscoverReply::set_id(::google::protobuf::uint32 value) {
  
  id_ = value;
  // @@protoc_insertion_point(field_set:bbque.DiscoverReply.id)
}
...
template <> struct is_proto_enum< ::bbque::DiscoverRequest_IAm> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::bbque::DiscoverRequest_IAm>() {
  return ::bbque::DiscoverRequest_IAm_descriptor();
}
template <> struct is_proto_enum< ::bbque::DiscoverReply_IAm> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::bbque::DiscoverReply_IAm>() {
  return ::bbque::DiscoverReply_IAm_descriptor();
}
