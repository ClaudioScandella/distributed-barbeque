...
#define PERF_COUNT_RAW_DRAM_UMASK_DCT0 	0x07
#define PERF_COUNT_RAW_DRAM_UMASK_DCT1 	0x38
#define PERF_COUNT_RAW_DRAM_ACCESS 	0xE0

#define DRAM_AC0 (PERF_COUNT_RAW_DRAM_ACCESS | \
		(PERF_COUNT_RAW_DRAM_UMASK_DCT0 << 8))
